...
export const Header: React.FC<HeaderProps> = ({ title }) => {
  ...
  return (
    ...
    >
      ...
      <div id="header-datetime" className="flex items-center gap-3 text-sm font-semibold">
        {!isInstalled && (
          <button
            type="button"
            onClick={handleInstallClick}
            className="flex items-center gap-1.5 bg-[#0070ba] hover:bg-[#005a96] text-white px-2.5 py-1 rounded text-xs font-bold transition-colors cursor-pointer shadow-xs"
